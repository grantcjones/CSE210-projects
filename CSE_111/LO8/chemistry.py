...
def main():
    ...
    user_chemical_formula = input("Enter the molecular formula of the sample: ")
    sample_mass = float(input("Enter the mass in grams of the sample: "))

    too_much_knowledge = make_periodic_table()
    symbols_quantity_list = parse_formula(user_chemical_formula, too_much_knowledge)
    molar_mass = compute_molar_mass(symbols_quantity_list, too_much_knowledge)
    ...
    print(get_formula_name(user_chemical_formula, known_molecules))
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for _ in range(len(symbol_quantity_list)):
        indv_symbol_quantity_list = symbol_quantity_list[_]
        symbol = indv_symbol_quantity_list[0]
        quantity = indv_symbol_quantity_list[1]
        locate_symbol = periodic_table_dict[symbol]
        atomic_mass = locate_symbol[1]
        indv_molar_mass = atomic_mass * quantity
        total_molar_mass = indv_molar_mass + total_molar_mass
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        molecule_formula = known_molecules_dict[formula]
        # formula_name = molecule_formula[1]
