...
def main():
    ...
    frm_main.master.title("Area of Cirlce")
...
def populate_main_window(frm_main):
    ...
    ent_age = nent.FloatEntry(frm_main, 0, 100, width=5)

    # Create a label that displays "Rates:"
    lbl_rates = tk.Label(frm_main, text="Area of Circle:")
    ...
    def calculate(event):
        ...
        try:
            ...
            # Display the areaest and fastest benficial
            # heart rates for the user to see.
            lbl_slow.config(text=f"{area:.2f}")
